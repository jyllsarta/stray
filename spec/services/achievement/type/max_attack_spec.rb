...
RSpec.describe Achievement::Type::MaxAttack, type: :model do
  let!(:user){ User.create }
  let!(:achievement){ create(:achievement, type: "Achievement::Type::MaxAttack") }
  ...
  describe "#progress_achievement" do
    ...
    context "追加の装備があるとき" do
      ...
      it "proceeds user_achievement" do
        aggregate_failures do
          expect{subject}.to change(user_achievement, :progress).to(1000)
        end
      end
    end
