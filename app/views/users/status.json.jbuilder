json.payload do
  ...
  json.status @status, :current_dungeon_id, :current_dungeon_depth, :current_dungeon_rank, :coin, :star, :velocity, :max_item_rank_for_rankup, :returns_on_death, :skill_slot_count
  json.status do
